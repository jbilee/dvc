export const dragonList = [
  ...
  // { name: ["Valcan", "발칸"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["", ""], QuickWitted: [0, 0, 0, 0], Quirky: [0, 0, 0, 0] },
  ...
  { name: ["Cuanade", "큐아네드"], traitsEn: ["Docile", "Hardy"], traitsKo: ["", ""], Docile: [0, 10, 10, 25], Hardy: [0, 0, 30, 10] },
