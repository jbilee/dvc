export const dragonList = [
  ...
  // { name: ["Record Dragon", "레코드 드래곤"], traitsEn: ["Calm", "Naive"], traitsKo: ["차분한", "천진난만한"], Calm: [5, 0, 20, 5], Naive: [0, 0, 0, 0] },
  ...
  // { name: ["Luacheia", ""], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Malcartis", "말카르티스"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
