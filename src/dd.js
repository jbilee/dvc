export const dragonList = [
  ...
  // { name: ["Semilla", "세밀라"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Aser", "아세르"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  { name: ["Chameleon Dragon", "카멜레용"], traitsEn: ["Quick Witted", "Smart"], traitsKo: ["눈치빠른", "똑똑한"], "Quick Witted": [10, 0, 0, 30], Smart: [20, 0, 0, 5] },
