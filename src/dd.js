export const dragonList = [
  ...
  // { name: ["Deserti", "데저티"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Opuntia Dragon", "백년초 드래곤"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  { name: ["Crevasse", "크레바스"], traitsEn: ["Quiet", "Unknown"], traitsKo: ["냉정한", "불명"], Quiet: [0, 10, 25, 10], Unknown: [0, 0, 0, 0] },
