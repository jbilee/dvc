export const dragonList = [
  ...
  // { name: ["Murger Dragon", "머거용"], traitsEn: ["Quick Witted", "Smart"], traitsKo: ["", ""], "Quick Witted": [0, 0, 0, 0], Smart: [0, 0, 0, 0] },
  ...
  // { name: ["Karna", "카르나"], traitsEn: ["Adamant", "Quiet"], traitsKo: ["고집있는", "냉정한"], Adamant: [10, 30, 10, 0], Quiet: [0, 0, 0, 0] },
