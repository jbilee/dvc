export const dragonList = [
  ...
  { name: ["Crepin", "크레핀"], traitsEn: ["Rash", "Unknown"], traitsKo: ["덜렁대는", "불명"], Rash: [30, 10, 0, 10], Unknown: [0, 0, 0, 0] },
  ...
  { name: ["Kirsch ragon", "키리쉬 드래곤"], traitsEn: ["Quirky", "Unknown"], traitsKo: ["변덕쟁이", "불명"], Quirky: [5, 20, 0, 5], Unknown: [0, 0, 0, 0] },
