export const dragonList = [
  ...
  { name: ["Rev", "레브"], traitsEn: ["Docile", "Unknown"], traitsKo: ["온순한", "불명"], Docile: [0, 15, 15, 30], Unknown: [0, 0, 0, 0] },
  ...
  { name: ["Blue Amber Dragon", "블루앰버 드래곤"], traitsEn: ["Quick Witted", "Unknown"], traitsKo: ["눈치빠른", "불명"], "Quick Witted": [25, 0, 5, 0], Unknown: [0, 0, 0, 0] },
  ...
  // { name: ["Hatsya", "하트샤"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
