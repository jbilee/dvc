export const dragonList = [
  ...
  // { name: ["Gothrelia", "고스렐리아"], traitsEn: ["Quirky", "TraitB"], traitsKo: ["변덕쟁이", ""], Quirky: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Psyche", "사이키"], traitsEn: ["Naive", "TraitB"], traitsKo: ["천진난만한", ""], Naive: [20, 0, 10, 10], TraitB: [0, 0, 0, 0] },
