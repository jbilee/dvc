export const dragonList = [
  ...
  // { name: ["Rusalka", "루살카"], traitsEn: ["Quiet", "Quirky"], traitsKo: ["냉정한", ""], Quiet: [0, 5, 20, 5], Quirky: [0, 0, 0, 0] },
  ...
  // { name: ["Venom", "베놈"], traitsEn: ["Quiet", "Careful"], traitsKo: ["", "신중한"], Quiet: [0, 5, 20, 5], Careful: [15, 15, 30, 0] },
