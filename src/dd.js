export const dragonList = [
  ...
  // { name: ["Nakir", "나키르"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Music Dragon", "뮤직 드래곤"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  { name: ["Aser", "아세르"], traitsEn: ["Brave", "Bold"], traitsKo: ["용감한", "대담한"], Brave: [0, 30, 10, 10], Bold: [5, 30, 0, 0] },
  ...
  { name: ["Espel", "에스펠"], traitsEn: ["Bold", "Careful"], traitsKo: ["대담한", "신중한"], Bold: [5, 25, 0, 0], Careful: [15, 15, 30, 0] },
