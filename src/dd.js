export const dragonList = [
  ...
  // { name: ["Life River", "라이프리버"], traitsEn: ["Brave", "Quirky"], traitsKo: ["용감한", ""], Brave: [0, 20, 10, 10], Quirky: [0, 0, 0, 0] },
  ...
  // { name: ["Coral Nessiebig", "산호 네시빅"], traitsEn: ["Docile", "Quirky"], traitsKo: ["온순한", ""], Docile: [0, 10, 10, 20], Quirky: [0, 0, 0, 0] },
  ...
  // { name: ["Qualle", "쿠알레"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["", ""], QuickWitted: [0, 0, 0, 0], Quirky: [0, 0, 0, 0] },
  ...
  // { name: ["Haemagon", "해마곤"], traitsEn: ["Bashful", "Quirky"], traitsKo: ["수줍은", ""], Bashful: [10, 0, 10, 25], Quirky: [0, 0, 0, 0] },
