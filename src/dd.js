export const dragonList = [
  ...
  // { name: ["Reishi Dragon", "영지버섯 드래곤"], traitsEn: ["Careful", "TraitB"], traitsKo: ["신중한", ""], Careful: [10, 10, 25, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Futurum", "푸투룸"], traitsEn: ["Quiet", "Calm"], traitsKo: ["냉정한", "차분한"], Quiet: [0, 0, 0, 0], Calm: [10, 0, 30, 10] },
