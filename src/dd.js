export const dragonList = [
  ...
  { name: ["Non", "논"], traitsEn: ["QuickWitted", "Quiet"], traitsKo: ["눈치빠른", "냉정한"], QuickWitted: [30, 10, 0, 0], Quiet: [0, 15, 30, 15] },
  { name: ["Snow Flower Popomo", "눈꽃 포포모"], traitsEn: ["Docile", "Naive"], traitsKo: ["온순한", "천진난만한"], Docile: [0, 10, 10, 20], Naive: [25, 0, 10, 10] },
  { name: ["Nidhogg", "니드호그"], traitsEn: ["QuickWitted", "Bold"], traitsKo: ["눈치빠른", "대담한"], QuickWitted: [25, 5, 0, 0], Bold: [0, 30, 0, 5] },
  { name: ["Ninmunia", "닌므니아"], traitsEn: ["Hardy", "QuickWitted"], traitsKo: ["노력하는", "눈치빠른"], Hardy: [5, 0, 20, 0], QuickWitted: [20, 10, 0, 0] },
  { name: ["Ninja Dragon", "닌자"], traitsEn: ["Careful", "QuickWitted"], traitsKo: ["신중한", "눈치빠른"], Careful: [5, 5, 20, 0], QuickWitted: [20, 0, 5, 0] },
  ...
  { name: ["Deep Blue Purple Lips", "딥블루 퍼플립스"], traitsEn: ["QuickWitted", "Smart"], traitsKo: ["눈치빠른", "똑똑한"], QuickWitted: [25, 0, 5, 0], Smart: [5, 0, 0, 30] },
  ...
  { name: ["Lios", "라이오스"], traitsEn: ["Hardy", "QuickWitted"], traitsKo: ["노력하는", "눈치빠른"], Hardy: [0, 0, 30, 10], QuickWitted: [30, 5, 0, 0] },
  ...
  { name: ["Lady Dragon", "레이디"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["눈치빠른", "변덕쟁이"], QuickWitted: [20, 0, 0, 10], Quirky: [5, 20, 0, 5] },
  ...
  { name: ["Lucio", "루시오"], traitsEn: ["QuickWitted", "Quiet"], traitsKo: ["눈치빠른", "냉정한"], QuickWitted: [30, 5, 0, 0], Quiet: [0, 15, 30, 15] },
  ...
  // { name: ["Mystic Arts", "미스틱아츠"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  { name: ["Bato", "바토"], traitsEn: ["QuickWitted", "Naive"], traitsKo: ["눈치빠른", "천진난만한"], QuickWitted: [20, 0, 0, 10], Naive: [30, 0, 10, 10] },
  ...
  { name: ["Vetala", "베타라"], traitsEn: ["QuickWitted", "Adamant"], traitsKo: ["눈치빠른", "고집있는"], QuickWitted: [20, 5, 0, 0], Adamant: [5, 20, 5, 0] },
  { name: ["Vefal", "베팔"], traitsEn: ["QuickWitted", "Smart"], traitsKo: ["눈치빠른", "똑똑한"], QuickWitted: [30, 0, 5, 0], Smart: [5, 0, 0, 20] },
  ...
  { name: ["Black Armor Spear", "블랙아머스피어"], traitsEn: ["QuickWitted", "Careful"], traitsKo: ["눈치빠른", "신중한"], QuickWitted: [20, 5, 0, 0], Careful: [10, 10, 30, 0] },
  ...
  { name: ["Siamese Dragon", "샴"], traitsEn: ["QuickWitted", "Hasty"], traitsKo: ["눈치빠른", "성급한"], QuickWitted: [25, 0, 0, 0], Hasty: [20, 5, 5, 0] },
  ...
  { name: ["Serpent Flower", "서펀트플라워"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["눈치빠른", "변덕쟁이"], QuickWitted: [30, 10, 0, 0], Quirky: [10, 20, 0, 10] },
  ...
  { name: ["Sluha", "슬루하"], traitsEn: ["QuickWitted", "Bold"], traitsKo: ["눈치빠른", "대담한"], QuickWitted: [20, 0, 0, 5], Bold: [0, 30, 5, 0] },
  ...
  { name: ["Thunderlips", "썬더립스"], traitsEn: ["QuickWitted", "Quiet"], traitsKo: ["눈치빠른", "냉정한"], QuickWitted: [20, 0, 5, 0], Quiet: [0, 10, 30, 10] },
  { name: ["Thunderbolt Dragon", "썬더볼트 드래곤"], traitsEn: ["QuickWitted", "Brave"], traitsKo: ["눈치빠른", "용감한"], QuickWitted: [20, 0, 0, 10], Brave: [0, 25, 10, 10] },
  ...
  { name: ["Anurhada", "아누라다"], traitsEn: ["Adamant", "QuickWitted"], traitsKo: ["고집있는", "눈치빠른"], Adamant: [5, 20, 5, 0], QuickWitted: [20, 0, 0, 10] },
  { name: ["Adela", "아델라"], traitsEn: ["Bold", "Calm"], traitsKo: ["대담한", "차분한"], Bold: [0, 30, 5, 0], Calm: [10, 0, 30, 10] },
  { name: ["Araca", "아라카"], traitsEn: ["Brave", "QuickWitted"], traitsKo: ["용감한", "눈치빠른"], Brave: [0, 25, 10, 10], QuickWitted: [25, 0, 5, 0] },
  { name: ["Argo", "아르고"], traitsEn: ["QuickWitted", "Brave"], traitsKo: ["눈치빠른", "용감한"], QuickWitted: [20, 5, 0, 0], Brave: [0, 30, 10, 10] },
  ...
  { name: ["Auros", "아우로스"], traitsEn: ["Adamant", "QuickWitted"], traitsKo: ["고집있는", "눈치빠른"], Adamant: [10, 20, 10, 0], QuickWitted: [25, 0, 5, 0] },
  ...
  { name: ["Aqua Dragon", "아쿠아 드래곤"], traitsEn: ["QuickWitted", "Bashful"], traitsKo: ["눈치빠른", "수줍은"], QuickWitted: [20, 5, 0, 0], Bashful: [10, 0, 10, 25] },
  { name: ["Afrit", "아프리트"], traitsEn: ["Quiet", "QuickWitted"], traitsKo: ["냉정한", "눈치빠른"], Quiet: [0, 10, 25, 10], QuickWitted: [30, 10, 0, 0] },
  { name: ["Amdusias", "암두시아스"], traitsEn: ["Smart", "QuickWitted"], traitsKo: ["똑똑한", "눈치빠른"], Smart: [0, 0, 10, 20], QuickWitted: [30, 0, 0, 5] },
  ...
  { name: ["Applecheek", "애플칙"], traitsEn: ["QuickWitted", "Bashful"], traitsKo: ["눈치빠른", "수줍은"], QuickWitted: [20, 5, 0, 0], Bashful: [10, 0, 10, 20] },
  ...
  { name: ["Yurqa", "유르카"], traitsEn: ["Brave", "QuickWitted"], traitsKo: ["용감한", "눈치빠른"], Brave: [0, 30, 10, 10], QuickWitted: [30, 10, 0, 0] },
  { name: ["Yurion", "유리온"], traitsEn: ["Docile", "Smart"], traitsKo: ["온순한", "똑똑한"], Docile: [0, 10, 10, 20], Smart: [0, 0, 5, 30] },
  { name: ["Iguagon", "이구아곤"], traitsEn: ["QuickWitted", "Smart"], traitsKo: ["눈치빠른", "똑똑한"], QuickWitted: [25, 0, 0, 5], Smart: [0, 5, 0, 25] },
  ...
  { name: ["Icarus", "이카로스"], traitsEn: ["QuickWitted", "Naive"], traitsKo: ["눈치빠른", "천진난만한"], QuickWitted: [25, 0, 0, 5], Naive: [30, 0, 10, 10] },
  ...
  { name: ["Insect Queen", "인섹트퀸"], traitsEn: ["QuickWitted", "Smart"], traitsKo: ["눈치빠른", "똑똑한"], QuickWitted: [30, 0, 5, 0], Smart: [0, 10, 0, 30] },
  ...
  { name: ["Jarukah", "자루카"], traitsEn: ["Naive", "QuickWitted"], traitsKo: ["천진난만한", "눈치빠른"], Naive: [20, 0, 10, 10], QuickWitted: [20, 0, 5, 0] },
  ...
  // { name: ["Jump Dragon", "점프 드래곤"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  { name: ["Jimon", "즈믄"], traitsEn: ["QuickWitted", "Smart"], traitsKo: ["눈치빠른", "똑똑한"], QuickWitted: [25, 0, 0, 0], Smart: [10, 0, 0, 20] },
  ...
  { name: ["Blue Firetail", "청불나래"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["눈치빠른", "변덕쟁이"], QuickWitted: [20, 0, 0, 5], Quirky: [10, 25, 0, 10] },
  ...
  { name: ["Typhoon Dragon", "타이푼"], traitsEn: ["Quirky", "QuickWitted"], traitsKo: ["변덕쟁이", "눈치빠른"], Quirky: [10, 25, 0, 10], QuickWitted: [20, 5, 0, 0] },
  ...
  { name: ["Tiamat", "티아매트"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["눈치빠른", "변덕쟁이"], QuickWitted: [0, 0, 0, 0], Quirky: [10, 25, 0, 10] },
  ...
  { name: ["Seahorse Dragon", "해마곤"], traitsEn: ["Bashful", "QuickWitted"], traitsKo: ["수줍은", "눈치빠른"], Bashful: [10, 0, 10, 25], QuickWitted: [30, 5, 0, 0] },
  ...
  { name: ["Hurricane Dragon", "허리케인"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["눈치빠른", "변덕쟁이"], QuickWitted: [20, 0, 0, 0], Quirky: [15, 30, 0, 15] },
  ...
  { name: ["Haze", "헤이즈"], traitsEn: ["Calm", "QuickWitted"], traitsKo: ["차분한", "눈치빠른"], Calm: [10, 0, 20, 10], QuickWitted: [30, 10, 0, 0] },
  { name: ["Hekate", "헤카테"], traitsEn: ["Calm", "Quiet"], traitsKo: ["차분한", "냉정한"], Calm: [10, 0, 20, 10], Quiet: [0, 15, 30, 15] },
  { name: ["Hell Dragon", "헬"], traitsEn: ["Quirky", "QuickWitted"], traitsKo: ["변덕쟁이", "눈치빠른"], Quirky: [15, 30, 0, 15], QuickWitted: [20, 10, 0, 0] },
