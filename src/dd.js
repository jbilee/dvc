export const dragonList = [
  ...
  // { name: ["Rev", "레브"], traitsEn: ["Docile", "TraitB"], traitsKo: ["온순한", ""], Docile: [0, 15, 15, 30], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Blue Amber Dragon", "블루앰버 드래곤"], traitsEn: ["Quick Witted", "TraitB"], traitsKo: ["눈치빠른", ""], "Quick Witted": [25, 0, 5, 0], TraitB: [0, 0, 0, 0] },
