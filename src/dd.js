export const dragonList = [
  ...
  // { name: ["Naga", "나가"], traitsEn: ["Quiet", "Adamant"], traitsKo: ["", "고집있는"], Quiet: [0, 5, 20, 5], Adamant: [10, 30, 10, 0] },
  ...
  // { name: ["Manimekalai", "마니메칼라"], traitsEn: ["Naive", "Quirky"], traitsKo: ["천진난만한", ""], Naive: [0, 0, 0, 0], Quirky: [0, 0, 0, 0] },
  ...
  // { name: ["Megalodon", "메갈로돈"], traitsEn: ["Quirky", "sdf"], traitsKo: ["변덕쟁이", ""], Quirky: [10, 20, 0, 10], sdf: [0, 0, 0, 0] },
  ...
  // { name: ["Enix", "에닉스"], traitsEn: ["QuickWitted", "Quirky"], traitsKo: ["", ""], QuickWitted: [0, 0, 0, 0], Quirky: [0, 0, 0, 0] },
  ...
  // { name: ["Whale Dragon", "웨일 드래곤"], traitsEn: ["QuickWitted", "Naive"], traitsKo: ["", "천진난만한"], QuickWitted: [0, 0, 0, 0], Naive: [30, 0, 15, 15] },
  ...
  // { name: ["Tropheus", "트로페우스"], traitsEn: ["QuickWitted", "Quiet"], traitsKo: ["", "냉정한"], QuickWitted: [0, 0, 0, 0], Quiet: [0, 15, 30, 15] },
