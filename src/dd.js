export const dragonList = [
  ...
  // { name: ["Psyche", "사이키"], traitsEn: ["Naive", "Bashful"], traitsKo: ["천진난만한", "수줍은"], Naive: [20, 0, 10, 10], Bashful: [0, 0, 0, 0] },
  ...
  // { name: ["Symphonia", "심포니아"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
  ...
  // { name: ["Takchaka", "타크샤카"], traitsEn: ["TraitA", "TraitB"], traitsKo: ["", ""], TraitA: [0, 0, 0, 0], TraitB: [0, 0, 0, 0] },
