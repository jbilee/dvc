const dragonList = [
    ...
    // { name: ["Barian", "바리안"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Sigma", "시그마"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Archelon", "아르켈론"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Tail Dragon", "테일 드래곤"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["눈치빠른", ""], quickWitted: [20, 5, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Paprion", "파프리온"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Phantom", "팬텀"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Frozen", "프로즌"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
