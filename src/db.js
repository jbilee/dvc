const dragonList = [
    ...
    // { name: ["Tail Dragon", "테일 드래곤"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["눈치빠른", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Hekate", "헤카테"], traitsEn: ["Calm", "Quiet"], traitsKo: ["차분한", "냉정한"], Calm: [10, 0, 20, 10], Quiet: [0, 0, 0, 0] },
