const dragonList = [
    ...
    // { name: ["Mamunia", "맘므니아"], traitsEn: ["Docile", "Naive"], traitsKo: ["온순한", ""], Docile: [0, 10, 10, 20], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Bubble Dragon", "버블 드래곤"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Coelacanth", "실러캔스"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    // { name: ["Thunderbolt Dragon", "썬더볼트 드래곤"], traitsEn: ["quickWitted", "Naive"], traitsKo: ["", ""], quickWitted: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Eos", "에오스"], traitsEn: ["Bashful", "Bold"], traitsKo: ["수줍은", "대담한"], Bashful: [15, 0, 15, 30], Bold: [0, 0, 0, 0] },
    ...
    // { name: ["Cleio", "클레이오"], traitsEn: ["Careful", "Naive"], traitsKo: ["신중한", ""], Careful: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
    ...
    // { name: ["Fairy Dragon", "페어리"], traitsEn: ["Docile", "Naive"], traitsKo: ["온순한", "천진난만한"], Docile: [0, 0, 0, 0], Naive: [0, 0, 0, 0] },
