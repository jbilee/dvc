const dragonList = [
    ...
    // { name: ["Regnator", "레그나토르"], traitsEn: ["Bold", "Quiet"], traitsKo: ["", ""], Bold: [0, 0, 0, 0], Quiet: [0, 0, 0, 0] },
    ...
    // { name: ["Varunas", "바루나스"], traitsEn: ["Bold", "Quiet"], traitsKo: ["", "냉정한"], Bold: [0, 0, 0, 0], Quiet: [0, 0, 0, 0] },
    ...
    // { name: ["Anurhada", "아누라다"], traitsEn: ["Quiet", "Quirky"], traitsKo: ["", ""], Quiet: [0, 5, 20, 5], Quirky: [15, 30, 0, 15] },
